...
import io.github.novareseller.cache.autoconfigure.RedissonAutoConfiguration;
...
@ActiveProfiles(value = {"L2cache-open-springcache-redis"})
public class UseL2CacheOpenSpringCacheRedisTests extends BaseTester{
